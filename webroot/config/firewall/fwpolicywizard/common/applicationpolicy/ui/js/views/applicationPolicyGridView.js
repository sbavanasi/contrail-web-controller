...
define([
    ...
    'backbone',
    'contrail-view',
    'config/firewall/fwpolicywizard/common/applicationpolicy/ui/js/models/applicationPolicyModel',
    'config/firewall/fwpolicywizard/common/applicationpolicy/ui/js/views/fwPolicyWizardEditView'
], function (_, moment, Backbone, ContrailView, ApplicationPolicyModel, FWPolicyWizardEditView) {
    var fwPolicyWizardEditView = new FWPolicyWizardEditView(),
    //applicationPolicyEditView
        gridElId = "#" + ctwc.APPLICATION_POLICY_SET_GRID_ID;
    ...
    var getAppPolicyGridViewConfig = function (viewConfig) {
        return {
            elementId: cowu.formatElementId([ctwc.APPLICATION_POLICY_SET_LIST_VIEW_ID]),
            view: "SectionView",
            viewConfig: {
                rows: [
                    {
                        columns: [
                            {
                                elementId: ctwc.APPLICATION_POLICY_SET_GRID_ID,
        ...
        if(appPolicySetName !== ctwc.GLOBAL_APPLICATION_POLICY_SET) {
            var deleteActionConfig = ctwgc.getDeleteConfig('Delete',
                function(rowIndex) {
                    ...
                    fwPolicyWizardEditView.model = new ApplicationPolicyModel(dataItem);
                    fwPolicyWizardEditView.renderDeleteApplicationPolicy ({
        ...
        var headerActionConfig = [
            {
                ...
                "onClick" : function() {
                    ...
                    if(checkedRows && checkedRows.length > 0) {
                        fwPolicyWizardEditView.model = applicationPolicyModel;
                        fwPolicyWizardEditView.renderDeleteApplicationPolicy(
                            {"title": ctwl.TITLE_APP_POLICY_SET_MULTI_DELETE,
            ...
            },
            {
                ...
                "onClick": function () {
                    ...
                    fwPolicyWizardEditView.renderApplicationPolicy({
