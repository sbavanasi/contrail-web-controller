...
define([
    ...
    'contrail-view',
    'knockback',
    'config/firewall/fwpolicywizard/common/applicationpolicy/ui/js/models/fwPolicyWizardModel'
], function (_, ContrailView, Knockback, FWPolicyWizardModel) {
                        ...
                        columns: [
                            {
                                ...
                                viewPathPrefix: "config/firewall/fwpolicywizard/project/fwPolicyWizard/ui/js/views/",
    ...
    function getAddressGroup(viewConfig){
        return {
            ...
            app: cowc.APP_CONTRAIL_CONTROLLER,
            viewPathPrefix: "config/firewall/fwpolicywizard/project/addressgroups/ui/js/views/",
            viewConfig: $.extend(true, {}, viewConfig,
                                 {projectSelectedValueData: viewConfig.projectSelectedValueData})
        }
    }
    function getServiceGroup(viewConfig){
        return {
            ...
            app: cowc.APP_CONTRAIL_CONTROLLER,
            viewPathPrefix: "config/firewall/fwpolicywizard/project/servicegroup/ui/js/views/",
            viewConfig: $.extend(true, {}, viewConfig,
                                 {projectSelectedValueData: viewConfig.projectSelectedValueData})
        }
    }
    function getTag(viewConfig){
        return {
            ...
            view: "tagListView",
            app: cowc.APP_CONTRAIL_CONTROLLER,
            viewPathPrefix: "config/firewall/fwpolicywizard/project/tag/ui/js/views/",
            viewConfig: $.extend(true, {}, viewConfig,
                                 {projectSelectedValueData: viewConfig.projectSelectedValueData})
        }
    }
