...
define([
    'underscore',
    'contrail-view',
    'config/firewall/fwpolicywizard/common/addressgroups/ui/js/models/addressGroupModel',
    'config/firewall/fwpolicywizard/common/addressgroups/ui/js/views/addressGroupEditView'
