...
define([
    'underscore',
    'contrail-view',
    'config/firewall/fwpolicywizard/common/servicegroup/ui/js/models/serviceGroupModel',
    'config/firewall/fwpolicywizard/common/servicegroup/ui/js/views/serviceGroupEditView'
