...
define([
    ...
    var serviceGroupListView = ContrailView.extend({
        el: $(contentContainer),
        render: function () {
            var self = this,
    ...
    var getServiceGroupGridViewConfig = function (viewConfig) {
        return {
            elementId: cowu.formatElementId([ctwc.APS_SERVICE_GRP_SECTION_ID]),
            view: "SectionView",
            viewConfig: {
                rows: [
                    {
                        columns: [
                            {
                                ...
                                viewPathPrefix: "config/firewall/applicationpolicyset/common/servicegroup/ui/js/views/",
