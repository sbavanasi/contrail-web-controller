...
define([
    ...
    var addressGroupListView = ContrailView.extend({
        el: $(contentContainer),
        render: function () {
            var self = this,
    ...
    var getAddressGroupGridViewConfig = function (viewConfig) {
        return {
            elementId: cowu.formatElementId([ctwc.APS_ADDRESS_GRP_SECTION_ID]),
            view: "SectionView",
            viewConfig: {
                rows: [
                    {
                        columns: [
                            {
                                ...
                                viewPathPrefix: "config/firewall/applicationpolicyset/common/addressgroups/ui/js/views/",
