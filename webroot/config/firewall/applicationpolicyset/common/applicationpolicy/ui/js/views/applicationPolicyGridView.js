...
define([
    ...
    'backbone',
    'contrail-view',
    'config/firewall/applicationpolicyset/common/applicationpolicy/ui/js/models/applicationPolicyModel',
    'config/firewall/applicationpolicyset/common/applicationpolicy/ui/js/views/applicationPolicyEditView'
