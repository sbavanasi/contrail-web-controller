...
define([
    'underscore',
    'contrail-view',
    'config/firewall/applicationpolicyset/common/servicegroup/ui/js/models/serviceGroupModel',
    'config/firewall/applicationpolicyset/common/servicegroup/ui/js/views/serviceGroupEditView'
], function (_, ContrailView, ServiceGroupModel, ServiceGroupEditView) {
    var serviceGroupEditView = new ServiceGroupEditView(),
        gridElId = "#" + ctwc.APS_SERVICE_GRP_GRID_ID;
    ...
    var getServiceGroupGridViewConfig = function (viewConfig) {
        return {
            elementId: cowu.formatElementId([ctwc.APS_SERVICE_GRP_LIST_VIEW_ID]),
            view: "SectionView",
            viewConfig: {
                rows: [
                    {
                        columns: [
                            {
                                elementId: ctwc.APS_SERVICE_GRP_GRID_ID,
    ...
    function getRowActionConfig (viewConfig) {
        var rowActionConfig = [
            ctwgc.getEditConfig('Edit', function(rowIndex) {
                dataView = $('#' + ctwc.APS_SERVICE_GRP_GRID_ID).data("contrailGrid")._dataView;
                serviceGroupEditView.model = new ServiceGroupModel(dataView.getItem(rowIndex));
                serviceGroupEditView.renderServiceGroup({
                                      'mode':'edit',
            ...
            ctwgc.getDeleteConfig('Delete', function(rowIndex) {
               var dataItem = $('#' + ctwc.APS_SERVICE_GRP_GRID_ID).data('contrailGrid')._dataView.getItem(rowIndex);
    	...
    	var headerActionConfig = [
    		{
                ...
                "onClick" : function() {
                    ...
                    var checkedRows = $('#' + ctwc.APS_SERVICE_GRP_GRID_ID).data("contrailGrid").getCheckedRows();
