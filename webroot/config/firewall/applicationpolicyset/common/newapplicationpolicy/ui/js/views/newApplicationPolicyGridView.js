...
define([
    ...
    'backbone',
    'contrail-view',
    'config/firewall/applicationpolicyset/common/newapplicationpolicy/ui/js/models/newApplicationPolicyModel',
    'config/firewall/applicationpolicyset/common/newapplicationpolicy/ui/js/views/newApplicationPolicyEditView'
    ...
    var newApplicationPolicyGridView = ContrailView.extend({
        el: $(contentContainer),
        render: function () {
            var self = this,
   ...
   return newApplicationPolicyGridView;
});
