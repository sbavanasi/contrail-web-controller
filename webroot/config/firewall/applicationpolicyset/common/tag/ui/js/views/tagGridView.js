...
define([
    'underscore',
    'contrail-view',
    'config/firewall/applicationpolicyset/common/tag/ui/js/models/tagModel',
    'config/firewall/applicationpolicyset/common/tag/ui/js/views/tagEditView'
], function (_, ContrailView, TagModel, TagEditView) {
    var tagEditView = new TagEditView(),
        gridElId = "#" + ctwc.APS_TAG_GRID_ID;
    var isGlobal = true;
    ...
    var getTagGridViewConfig = function (viewConfig) {
        return {
            elementId: cowu.formatElementId([ctwc.APS_TAG_LIST_VIEW_ID]),
            view: "SectionView",
            viewConfig: {
                rows: [
                    {
                        columns: [
                            {
                                elementId: ctwc.APS_TAG_GRID_ID,
    ...
    function getRowActionConfig (viewConfig) {
        var rowActionConfig = [
            ctwgc.getDeleteConfig('Delete', function(rowIndex) {
               var dataItem = $('#' + ctwc.APS_TAG_GRID_ID).data('contrailGrid')._dataView.getItem(rowIndex);
               tagEditView.model = new TagModel(dataItem);
               tagEditView.renderTag({
        ...
        var headerActionConfig = [
            {
                ...
                "onClick" : function() {
                    ...
                    var checkedRows = $('#' + ctwc.APS_TAG_GRID_ID).data("contrailGrid").getCheckedRows();
